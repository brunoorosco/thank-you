...
const name = "Anderson Funicello";
const message = `"Deixo aqui meu agradecimento pelo seu esforço constante e pelo empenho que coloca em cada tarefa. 
Seu excepcional desempenho só reforça o quanto o seu compromisso faz a diferença. Parabéns por ser tão dedicado!"`;
